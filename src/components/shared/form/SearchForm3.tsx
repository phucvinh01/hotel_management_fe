...
const SearchForm3 = (props: searchForm3Props) => {
    const [scrollYSearchForm3, setScrollYSearchForm3] = useState<number>(0);
    ...
    useEffect(() => {
        const handleScroll = () => {
            setScrollYSearchForm3(window.scrollY);
        };
    ...
    return (
        <div className={` z-999 w-full ${scrollY > 20 ? 'fixed top-0' : ''}`}>
            <form
