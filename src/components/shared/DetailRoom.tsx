...
const DetailRoom = (props: IProps) => {
    ...
    return (
        rooms.filter(f1item => {
            return f1item.State == false
        }).length > (Number.parseInt((TotalRoom != null && TotalRoom != undefined) ? TotalRoom : '1')) ?
                ...
                <div className="w-full bg-gray-100 rounded-3xl flex  flex-col lg:flex-col p-3">
                    ...
                    <div className="w-full bg-gray-100 rounded-3xl flex flex-col lg:flex-row p-3">
                        ...
                        absolute text-white px-2 py-1 rounded-3xl m-2">1/{listImage.length}</p>
                            ...
                            {typeRoom.No_Moking ? <p className="flex pl-3 text-gray-900 font-bold text-lg my-2"><span>
                                <svg width="16" height="16" viewBox="0 0 16 16" fill="none" className="mx-2"
                                    xmlns="http://www.w3.org/2000/svg" data-id="IcHotelRoomNoSmokingArea16">
                                    <g clip-path="url(#clip0_10944_6443)">
                                        <path fill-rule="evenodd" clip-rule="evenodd" d="M3.77925 10H2C1.44772 10 1 10.4477 1 11V12.8363L3.77925 10ZM3.08001 15H11H13C14.1046 15 15 14.1046 15 13V12C15 10.8954 14.1046 10 13 10H11H7.97945L6.01967 12H10V13H5.03978L3.08001 15ZM12 13V12H13V13H12Z" fill="#687176"></path>
                                        <path fill-rule="evenodd" clip-rule="evenodd" d="M11.5504 2.06932C11.0985 1.42284 10.3486 1 9.5 1H8C7.44772 1 7 1.44772 7 2C7 2.55228 7.44772 3 8 3H9.5C9.77614 3 10 3.22386 10 3.5C10 3.54942 10.0014 3.59851 10.0043 3.64722L11.5504 2.06932ZM13.6064 4.25754L11.957 5.94086C12.1318 5.97958 12.3135 6 12.5 6C12.7761 6 13 6.22386 13 6.5V8.5C13 9.05228 13.4477 9.5 14 9.5C14.5523 9.5 15 9.05228 15 8.5V6.5C15 5.51654 14.4321 4.66572 13.6064 4.25754ZM7.89932 5.79537C7.59509 4.75774 6.63603 4 5.5 4H4C3.44772 4 3 3.55228 3 3V2C3 1.44772 2.55228 1 2 1C1.44772 1 1 1.44772 1 2V3C1 4.65685 2.34315 6 4 6H5.5C5.77614 6 6 6.22386 6 6.5C6 6.86127 6.07663 7.20464 6.21452 7.51475L7.89932 5.79537ZM8.95933 9L10.9191 7H11C11.5523 7 12 7.44772 12 8V8.5C12 9.05228 11.5523 9.5 11 9.5C10.6299 9.5 10.3067 9.2989 10.1338 9H8.95933Z" fill="#0194f3"></path>
                                        <path d="M1.17932 14.7965L14.4989 1.20355" stroke="#687176" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path></g><defs><clipPath id="clip0_10944_6443"><rect width="16" height="16" fill="white"></rect></clipPath></defs></svg>
                            </span>Không hút thuốc</p> : null}
                            ...
                            <div className=" w-full flex flex-col bg-white my-2 lg:my-0 lg:ml-3 rounded-3xl  p-3 mb-3">
                                ...
                                <div className="flex flex-row my-3">
                                    <div className="w-4/12 flex justify-start items-center">
                                        <span><img src="/icon/giuong.webp" className="w-6 h-6" /></span>
                                        <p className="text-gray-900 font-semibold ml-2 text-lg">
                                            {`${typeRoom.SoLuongGiuong}-${typeRoom.TenLoaiGiuong}`}</p>
                                    </div>

                                    <div className="w-4/12 flex justify-start items-center">
                                        <span><img src="/icon/khach.webp" className="w-6 h-6" /></span>
                                        <p className="text-gray-900 font-semibold ml-2 text-lg">{typeRoom.MaxQuantityMember} người</p>
                                    </div>
                                    <div className="w-4/12 flex justify-start items-end">
                                        <p className="text-red-500 w-full font-semibold ml-2 text-lg text-right">(Còn trống {rooms ? getRoomEmpty(rooms) + '/' + rooms.length + ' phòng' : null})</p>
                                    </div>
                                </div>
                                <hr />
                                {rooms ? rooms.filter(fitem => { return fitem.State == false }).map((item) => (
                                    ...
                                    <div className="flex flex-row flex-wrap my-3 border-b">
                                        <div className="w-1/2 lg:w-4/12  flex flex-col justify-start items-start">
                                            <div className="flex flex-row">
                                                ...
                                                <p className={`${item.Breakfast ? 'text-blue-700' : 'text-gray-300'} font-bold ml-2 text-lg`}>
                                            ...
                                            ${item.Wifi ? 'text-blue-600' : 'text-gray-300'}`}>
                                                ...
                                                <p className={`${item.Wifi ? 'text-blue-700' : 'text-gray-300'} font-bold ml-2 text-lg`}>
                                                    WiFi miễn phí
                                                </p>
                                            </div>
                                            ...
                                            <div className="flex flex-row">
                                                <span>
                                                    <svg width="16" height="16" viewBox="0 0 16 16" fill="none" className={`${item.NoMoking ? 'opacity-100' : 'opacity-50'}`}
                                                        xmlns="http://www.w3.org/2000/svg" data-id="IcHotelRoomNoSmokingArea16">
                                                        <g clip-path="url(#clip0_10944_6443)">
                                                            <path fill-rule="evenodd" clip-rule="evenodd" d="M3.77925 10H2C1.44772 10 1 10.4477 1 11V12.8363L3.77925 10ZM3.08001 15H11H13C14.1046 15 15 14.1046 15 13V12C15 10.8954 14.1046 10 13 10H11H7.97945L6.01967 12H10V13H5.03978L3.08001 15ZM12 13V12H13V13H12Z" fill="#687176"></path>
                                                            <path fill-rule="evenodd" clip-rule="evenodd" d="M11.5504 2.06932C11.0985 1.42284 10.3486 1 9.5 1H8C7.44772 1 7 1.44772 7 2C7 2.55228 7.44772 3 8 3H9.5C9.77614 3 10 3.22386 10 3.5C10 3.54942 10.0014 3.59851 10.0043 3.64722L11.5504 2.06932ZM13.6064 4.25754L11.957 5.94086C12.1318 5.97958 12.3135 6 12.5 6C12.7761 6 13 6.22386 13 6.5V8.5C13 9.05228 13.4477 9.5 14 9.5C14.5523 9.5 15 9.05228 15 8.5V6.5C15 5.51654 14.4321 4.66572 13.6064 4.25754ZM7.89932 5.79537C7.59509 4.75774 6.63603 4 5.5 4H4C3.44772 4 3 3.55228 3 3V2C3 1.44772 2.55228 1 2 1C1.44772 1 1 1.44772 1 2V3C1 4.65685 2.34315 6 4 6H5.5C5.77614 6 6 6.22386 6 6.5C6 6.86127 6.07663 7.20464 6.21452 7.51475L7.89932 5.79537ZM8.95933 9L10.9191 7H11C11.5523 7 12 7.44772 12 8V8.5C12 9.05228 11.5523 9.5 11 9.5C10.6299 9.5 10.3067 9.2989 10.1338 9H8.95933Z" fill="#0194f3"></path>
                                                ...
                                                <p className={`${item.NoMoking ? 'text-gray-300' : 'text-blue-700'} font-bold ml-2 text-lg`}>
                                                    Không hút thuốc
                                                </p>
                                            </div>
                                        </div>
                                        ...
                                        <div className="w-1/2 lg:w-4/12 flex flex-col justify-start items-start">
                                            <div className="flex flex-row relative group">
                                                <span>
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className={`${item.Cancel ? 'text-blue-700' : 'text-gray-300'} bi bi-receipt-cutoff`} viewBox="0 0 16 16">
                                                ...
                                                {item.Cancel ? (<div className="w-[350px] absolute top-10 ml-[-50%] rounded-3xl bg-slate-950 z-10 opacity-85
                                    ...
                                    ml-[30%] absolute top-[-5px]'></div>
                                                    <div className="flex flex-row justify-start items-center"><span>
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className={`text-green-600 font-semibold bi bi-receipt-cutoff`} viewBox="0 0 16 16">
                                                            <path d="M3 4.5a.5.5 0 0 1 .5-.5h6a.5.5 0 1 1 0 1h-6a.5.5 0 0 1-.5-.5m0 2a.5.5 0 0 1 .5-.5h6a.5.5 0 1 1 0 1h-6a.5.5 0 0 1-.5-.5m0 2a.5.5 0 0 1 .5-.5h6a.5.5 0 1 1 0 1h-6a.5.5 0 0 1-.5-.5m0 2a.5.5 0 0 1 .5-.5h6a.5.5 0 0 1 0 1h-6a.5.5 0 0 1-.5-.5m0 2a.5.5 0 0 1 .5-.5h6a.5.5 0 0 1 0 1h-6a.5.5 0 0 1-.5-.5M11.5 4a.5.5 0 0 0 0 1h1a.5.5 0 0 0 0-1zm0 2a.5.5 0 0 0 0 1h1a.5.5 0 0 0 0-1zm0 2a.5.5 0 0 0 0 1h1a.5.5 0 0 0 0-1zm0 2a.5.5 0 0 0 0 1h1a.5.5 0 0 0 0-1zm0 2a.5.5 0 0 0 0 1h1a.5.5 0 0 0 0-1z" />
                                                            <path d="M2.354.646a.5.5 0 0 0-.801.13l-.5 1A.5.5 0 0 0 1 2v13H.5a.5.5 0 0 0 0 1h15a.5.5 0 0 0 0-1H15V2a.5.5 0 0 0-.053-.224l-.5-1a.5.5 0 0 0-.8-.13L13 1.293l-.646-.647a.5.5 0 0 0-.708 0L11 1.293l-.646-.647a.5.5 0 0 0-.708 0L9 1.293 8.354.646a.5.5 0 0 0-.708 0L7 1.293 6.354.646a.5.5 0 0 0-.708 0L5 1.293 4.354.646a.5.5 0 0 0-.708 0L3 1.293zm-.217 1.198.51.51a.5.5 0 0 0 .707 0L4 1.707l.646.647a.5.5 0 0 0 .708 0L6 1.707l.646.647a.5.5 0 0 0 .708 0L8 1.707l.646.647a.5.5 0 0 0 .708 0L10 1.707l.646.647a.5.5 0 0 0 .708 0L12 1.707l.646.647a.5.5 0 0 0 .708 0l.509-.51.137.274V15H2V2.118z" />
                                                        </svg>
                                                    </span>
                                                        <p className="text-green-600 font-semibold my-2">
                                                            ...
                                                            Miễn phí hủy trước {item.TimeRecive.toString()}</p></div>
                                                    <hr className="bg-green-600" />
                                                    <div className="flex flex-row my-2 relative">
                                                        <span className="absolute left-[65%] top-[-15px]">
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="text-red-600 bi bi-record-fill" viewBox="0 0 16 16">
                                                                <path fill-rule="evenodd" d="M8 13A5 5 0 1 0 8 3a5 5 0 0 0 0 10" />
                                                            </svg>
                                                        </span>
                                                        <p className="text-green-600 font-semibold w-8/12">
                                                            Miễn phí hủy trước {item.TimeRecive.toString()}</p>
                                                        <p className="text-red-500  font-semibold w-4/12">Không thể hoàn tiền</p>
                                                    </div>
                                                    <p>Bạn có thể đổi ngày lưu trú hoặc hủy trước ngày {item.TimeRecive.toString()}
                                                        . Nếu bạn thay đổi hoặc hủy sau thời gian trên, bạn có thể chịu phí hủy.
                                                    </p>
                                                    <p>Thời gian hiển thị là giờ địa phương của khách sạn.</p>
                                            ...
                                            <div className="flex flex-row">
                                                ...
                                                <p className={`${item.ChangeTimeRecive ? 'text-blue-700' : 'text-gray-300'} font-bold ml-2 text-lg`}>
                                                    Có thể đổi lịch
                                                </p>
                                            </div>
                                            ...
                                            <div className="flex flex-row items-start">
                                                ...
                                                <div className="flex flex-col relative group cursor-pointer">
                                                    <p className={`text-blue-700 font-bold ml-2 text-lg`}>
                                                        {item.Hinh_Thuc_Thanh_Toan ? 'Thanh toán online' : 'Thanh toán trực tiếp'}
                                                    </p>
                                                    ...
                                                    <div className="w-[350px] absolute top-15 ml-[-50%] rounded-lg z-10
                                    ...
                                    ml-[30%] absolute top-[-5px]'></div>
                                                        ...
                                                        <p>Cho chuyến đi thêm linh hoạt: KHÔNG CẦN THANH TOÁN NGAY khi đặt phòng!
                                                            Bạn có thể đặt ngay phòng có giá tốt nhất hôm nay và thanh toán sau bằng
                                                            tiền mặt hoặc thẻ khi nhận phòng.
                                                        </p>
