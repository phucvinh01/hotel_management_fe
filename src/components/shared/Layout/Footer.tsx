            ...
            <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
                <div className="md:flex md:justify-between">
                    ...
                    <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-4">
                        <div>
                            <Link href={'app/about'} className="mb-6 text-sm font-semibold text-white uppercase dark:text-white">Về chúng tôi</Link>
                        </div>
                        <div>
                ...
                <div className="sm:flex sm:items-center sm:justify-between">
                    <span className="text-sm text-white sm:text-center dark:text-gray-400">© 2023 <Link href="https://flowbite.com/" className="hover:underline">Flowbite™</Link>. All Rights Reserved.
                    </span>
                    <div className="flex mt-4 sm:justify-center sm:mt-0">
                        ...
                        <Link href="#" className="text-white hover:text-gray-900 dark:hover:text-white ms-5">
