  ...
  return (
    <Card className={`border-none p-0 space-y-2 ${className}`}>
              ...
              <CardContent className='flex flex-col gap-4 py-1 max-h-52 p-0'>
                ...
                <p className='flex items-center gap-1'> <span><StarIcon size={18} fill='yellow'/></span> <span className='font-semibold'>{item.average_rating === null ? 0 : item.average_rating}</span> </p>
                </div>
