...
export function DataTableFacetedFilter<TData, TValue>({
  ...
  return (
    <Popover>
        ...
        <Button variant="outline" size="sm" className="h-8 border-dashed">
          ...
          {selectedValues?.size > 0 && (
            <>
              ...
              <Badge
                variant="secondary"
                className="rounded-3xl px-1 font-normal lg:hidden"
              >
                {selectedValues.size}
              </Badge>
              <div className="hidden space-x-1 lg:flex">
                {selectedValues.size > 2 ? (
                  <Badge
                    variant="secondary"
                    className="rounded-3xl px-1 font-normal"
                  >
      ...
      <PopoverContent className="w-[200px] p-0 text-black bg-white" align="start">
        <Command>
