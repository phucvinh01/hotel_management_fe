...
const TableFour: React.FC = () => {
  return (
    <div className="col-span-12 xl:col-span-7">
      <div className="rounded-3xl border border-stroke bg-white px-5 pb-2.5 pt-6 shadow-default dark:border-strokedark dark:bg-black sm:px-7.5 xl:pb-1">
        ...
        <div className="flex flex-col">
          <div className="grid grid-cols-3 rounded-3xl bg-gray-2 dark:bg-meta-4 sm:grid-cols-4">
