          ...
          {isEdit !== true ? (
            <div className='grid gird-col-12  p-4 border-t'>
              ...
              <div className='mt-4 col-span-6 space-y-3'>
                ...
                <dl className='grid grid-cols-2 gap-4'>
                  ...
                  <dd className='font-bold text-[14px]'>
                    {
                      typedData.find((item) => item.id === formData.TypeRoomId)
                        ?.RoomName
                    }
                  </dd>
              ...
              <div className='mt-4 col-span-12'>
                ...
                <ul className='list-disc pl-4 mt-2'>
                  ...
                  <li
                    hidden={formData.Bao_Gom_Thue_Va_Phi === 0 ? true : false}>
                    {formData.Bao_Gom_Thue_Va_Phi === 1
                      ? 'Đã bao gồm thuế và phí'
                      : ''}
                  </li>
                  <li
                    hidden={formData.Hinh_Thuc_Thanh_Toan === 0 ? true : false}>
            ...
            <div className='grid gap-4 py-4 grid-cols-12'>
              ...
              <div className='flex space-y-2 flex-col col-span-6'>
                ...
                <Select
                  name='state'
                  defaultValue={formData.State === 0 ? 'Trống' : 'Đang thuê'}
                  required
                  onValueChange={(e) =>
              ...
              <div className='flex items-center space-x-2 col-span-4'>
                <Checkbox
                  id='payment'
                  defaultChecked={
                    formData.Hinh_Thuc_Thanh_Toan === 1 ? true : false
                  }
                  onCheckedChange={(e) =>
                    setFormData((prev) => ({
                      ...prev!,
              ...
              <div className='flex items-center space-x-2 col-span-4'>
                <Checkbox
                  id='fax'
                  defaultChecked={
                    formData.Bao_Gom_Thue_Va_Phi === 1 ? true : false
                  }
                  onCheckedChange={(e) =>
                    setFormData((prev) => ({
                      ...prev!,
