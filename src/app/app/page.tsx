          ...
          <form>
            ...
            <div className="mb-4 relative" >
              ...
              <div id='dsTinh' className={`${dsTinhState} bg-white rounded-3xl w-full absolute z-10 shadow-md shadow-cyan-700`}>
                ...
                {provinces.map((item, index) => (
                  <div key={index} className="row-modal-ds-tinh" onClick={() => handleSelectedTinh(item.DisplayName)}>
            ...
            <div className="flex flex-row my-5 justify-between">
              ...
              <div className="w-4/12 relative pr-6">
                ...
                h-[360px] overflow-hidden overflow-y-auto`}>
                  ...
                  {dsDate.map((item, index) => (
                    <div key={index} className="row-modal-ds-tinh" onClick={() => {
            ...
            <div className='flex flex-row my-5 justify-between'>
              ...
              <div className='w-4/12 pr-6  items-end'>
                ...
                <Link href={`app/hotel/search?province=${valueTinh}&totalnight=${valueSoDem.split(' ')[0]}&totalmember=${valueSoNguoiLon}&totalmemberchild=${valueSoTreEm}&timereceive=${startDate}&totalroom=${valueSoPhong}`}
            ...
            <CarouselContent className="">
              {provinces.map((item) => (
                <CarouselItem key={item.id} className="basis-1/5">
                  <Link href={`app/hotel/search?provinceid=${item.id}`}>
