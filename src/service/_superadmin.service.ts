...
export const getTotalRegisterByType = async (): Promise<TotalRegisterByType> => {
  try {
    const res = await http.get<TotalRegisterByType>(`/get-total-register-by-type`);
    return res.data;
  } catch (error) {
    throw error;
  }
...
export const getCurrentMonthBookings = async (): Promise<CurrentMonthBookings> => {
  try {
    const res = await http.get<CurrentMonthBookings>(`/get-current-month-bookings`);
    return res.data;
  } catch (error) {
    throw error;
  }
...
export const getStatistics = async (month:string): Promise<Statistics> => {
  try {
    const res = await http.get<Statistics>(`/get-statistics-by-month?month=${month}`);
    return res.data;
  } catch (error) {
    throw error;
  }
...
export const getHotelRegisterByMonth = async (month:string): Promise<User[]> => {
  try {
    const res = await http.get<User[]>(`/get-user-staff-registrations?monthYear=${month}`);
    return res.data;
  } catch (error) {
    throw error;
  }
